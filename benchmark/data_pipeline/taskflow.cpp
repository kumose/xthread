...
std::chrono::microseconds parallel_pipeline_taskflow_1_pipe(
  ...
  xthread::DataPipeline pl(num_lines,
    xthread::make_data_pipe<xthread::Pipeflow&, void>(xthread::PipeType::SERIAL, [size](xthread::Pipeflow& pf) -> void{
      if(pf.token() == size) {
        pf.stop();
      }
    })
...
std::chrono::microseconds parallel_pipeline_taskflow_2_pipes(
  ...
  auto beg = std::chrono::high_resolution_clock::now();
  xthread::DataPipeline pl(num_lines,
    xthread::make_data_pipe<xthread::Pipeflow&, int>(xthread::PipeType::SERIAL, [size](xthread::Pipeflow& pf) -> int{
      if(pf.token() == size) {
        pf.stop();
        return 0;
      }
    ...
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[1]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_3_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, int>(to_pipe_type(pipes[1]), int2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[2]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_4_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, float>(to_pipe_type(pipes[1]), int2float),
    xthread::make_data_pipe<float, int>(to_pipe_type(pipes[2]), float2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[3]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_5_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, float>(to_pipe_type(pipes[1]), int2float),
    xthread::make_data_pipe<float, int>(to_pipe_type(pipes[2]), float2int),
    xthread::make_data_pipe<int, int>(to_pipe_type(pipes[3]), int2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[4]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_6_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, float>(to_pipe_type(pipes[1]), int2float),
    xthread::make_data_pipe<float, int>(to_pipe_type(pipes[2]), float2int),
    xthread::make_data_pipe<int, std::string>(to_pipe_type(pipes[3]), int2string),
    xthread::make_data_pipe<std::string, int>(to_pipe_type(pipes[4]), string2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[5]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_7_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::string>(to_pipe_type(pipes[3]), int2string),
    xthread::make_data_pipe<std::string, int>(to_pipe_type(pipes[4]), string2int),
    xthread::make_data_pipe<int, int>(to_pipe_type(pipes[5]), int2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[6]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_8_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::string>(to_pipe_type(pipes[3]), int2string),
    xthread::make_data_pipe<std::string, int>(to_pipe_type(pipes[4]), string2int),
    xthread::make_data_pipe<int, std::vector<int> >(to_pipe_type(pipes[5]), int2vector),
    xthread::make_data_pipe<std::vector<int>, int>(to_pipe_type(pipes[6]), vector2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[7]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_9_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::vector<int> >(to_pipe_type(pipes[5]), int2vector),
    xthread::make_data_pipe<std::vector<int>, int>(to_pipe_type(pipes[6]), vector2int),
    xthread::make_data_pipe<int, int>(to_pipe_type(pipes[7]), int2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[8]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_10_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::vector<int> >(to_pipe_type(pipes[5]), int2vector),
    xthread::make_data_pipe<std::vector<int>, int>(to_pipe_type(pipes[6]), vector2int),
    xthread::make_data_pipe<int, float>(to_pipe_type(pipes[7]), int2float),
    xthread::make_data_pipe<float, int>(to_pipe_type(pipes[8]), float2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[9]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_11_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, float>(to_pipe_type(pipes[7]), int2float),
    xthread::make_data_pipe<float, int>(to_pipe_type(pipes[8]), float2int),
    xthread::make_data_pipe<int, int>(to_pipe_type(pipes[9]), int2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[10]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_12_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, float>(to_pipe_type(pipes[7]), int2float),
    xthread::make_data_pipe<float, int>(to_pipe_type(pipes[8]), float2int),
    xthread::make_data_pipe<int, std::string>(to_pipe_type(pipes[9]), int2string),
    xthread::make_data_pipe<std::string, int>(to_pipe_type(pipes[10]), string2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[11]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_13_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::string>(to_pipe_type(pipes[9]), int2string),
    xthread::make_data_pipe<std::string, int>(to_pipe_type(pipes[10]), string2int),
    xthread::make_data_pipe<int, int>(to_pipe_type(pipes[11]), int2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[12]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_14_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::string>(to_pipe_type(pipes[9]), int2string),
    xthread::make_data_pipe<std::string, int>(to_pipe_type(pipes[10]), string2int),
    xthread::make_data_pipe<int, std::vector<int> >(to_pipe_type(pipes[11]), int2vector),
    xthread::make_data_pipe<std::vector<int>, int>(to_pipe_type(pipes[12]), vector2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[13]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_15_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::vector<int> >(to_pipe_type(pipes[11]), int2vector),
    xthread::make_data_pipe<std::vector<int>, int>(to_pipe_type(pipes[12]), vector2int),
    xthread::make_data_pipe<int, int>(to_pipe_type(pipes[13]), int2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[14]), int2void)
  );
...
std::chrono::microseconds parallel_pipeline_taskflow_16_pipes(
  ...
  xthread::DataPipeline pl(num_lines,
    ...
    xthread::make_data_pipe<int, std::vector<int> >(to_pipe_type(pipes[11]), int2vector),
    xthread::make_data_pipe<std::vector<int>, int>(to_pipe_type(pipes[12]), vector2int),
    xthread::make_data_pipe<int, float>(to_pipe_type(pipes[13]), int2float),
    xthread::make_data_pipe<float, int>(to_pipe_type(pipes[14]), float2int),
    xthread::make_data_pipe<int, void>(to_pipe_type(pipes[15]), int2void)
  );
