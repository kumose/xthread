...
std::chrono::microseconds graph_pipeline_taskflow_1_pipe(
  ...
  xthread::Pipeline pl(num_lines,
    xthread::Pipe{xthread::PipeType::SERIAL, Input{0, 0, mybuffer, graph}} // 1st pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_2_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    xthread::Pipe{xthread::PipeType::SERIAL, Input{0, 0, mybuffer, graph}}, // 1st pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 2nd pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_3_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    xthread::Pipe{xthread::PipeType::SERIAL, Input{0, 0, mybuffer, graph}}, // 1st pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 2nd pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 3rd pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_4_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    xthread::Pipe{xthread::PipeType::SERIAL, Input{0, 0, mybuffer, graph}}, // 1st pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 2nd pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 3rd pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 4th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_5_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 2nd pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 3rd pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 4th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 5th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_6_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 3rd pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 4th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 5th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 6th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_7_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 4th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 5th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 6th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 7th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_8_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 5th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 6th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 7th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 8th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_9_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 6th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 7th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 8th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 9th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_10_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 7th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 8th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 9th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 10th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_11_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 8th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 9th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 10th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 11th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_12_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 9th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 10th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 11th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 12th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_13_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 10th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 11th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 12th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 13th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_14_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 11th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 12th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 13th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 14th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_15_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 12th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 13th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 14th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 15th pipe
  );
...
std::chrono::microseconds graph_pipeline_taskflow_16_pipes(
  ...
  xthread::Pipeline pl(num_lines,
    ...
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 13th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 14th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, Filter{mybuffer, graph}},      // 15th pipe
    xthread::Pipe{xthread::PipeType::SERIAL, FilterFinal{mybuffer, graph}}  // 16th pipe
  );
