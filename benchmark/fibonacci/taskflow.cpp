...
size_t spawn_async(size_t num_fibonacci, xthread::Runtime& rt) {
  ...
  rt.silent_async([num_fibonacci, &res1](xthread::Runtime& rt1){
...
size_t fibonacci_taskflow(size_t num_threads, size_t num_fibonacci) {
  ...
  get_executor().async([num_fibonacci, &res](xthread::Runtime& rt){
