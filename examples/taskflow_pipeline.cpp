...
void make_taskflow1(xthread::Taskflow& tf) {
...
void make_taskflow2(xthread::Taskflow& tf) {
...
void make_taskflow3(xthread::Taskflow& tf) {
...
int main() {
  ...
  xthread::Taskflow taskflow("taskflow processing pipeline");
  ...
  std::array<xthread::Taskflow, num_pipes> taskflows;
