...
namespace xthread {
    ...
    */
    ...
    to schedule parallel iterations (e.g., xthread::Taskflow::for_each).

    An partitioner defines the scheduling method for running parallel algorithms,
    such xthread::Taskflow::for_each, xthread::Taskflow::reduce, and so on.
    By default, we provide the following partitioners:

    + xthread::GuidedPartitioner  to enable guided scheduling algorithm of adaptive chunk size
    + xthread::DynamicPartitioner to enable dynamic scheduling algorithm of equal chunk size
    + xthread::StaticPartitioner  to enable static scheduling algorithm of static chunk size
    + xthread::RandomPartitioner  to enable random scheduling algorithm of random chunk size
    ...
    iteration, xthread::StaticPartitioner can deliver the best performance.
    On the other hand, if the work unit per iteration is irregular and unbalanced,
    xthread::GuidedPartitioner or xthread::DynamicPartitioner can outperform xthread::StaticPartitioner.
    In most situations, xthread::GuidedPartitioner can deliver decent performance and
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xthread::StaticPartitioner(0, [](auto&& closure){
    ...
    @attention
    The default closure wrapper (xthread::DefaultClosureWrapper) does nothing but invoke
    ...
    */
    ...
    @tparam C closure wrapper type (default xthread::DefaultClosureWrapper)
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xthread::GuidedPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xthread::DynamicPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    Similar to xthread::DynamicPartitioner,
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      xthread::RandomPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    /**
    @brief default partitioner set to xthread::GuidedPartitioner
    ...
    */
    ...
    A partitioner is a derived type from xthread::PartitionerBase.
    */
    template<typename P>
