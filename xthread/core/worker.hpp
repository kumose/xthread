...
#include <xthread/core/atomic_notifier.hpp>
#include <xthread/core/nonblocking_notifier.hpp>
...
namespace xthread {
    ...
    */
    ...
    from an observer derived from xthread::ObserverInterface.
    */
    class WorkerView {
        friend class Executor;
    ...
    The xthread::WorkerInterface class allows users to customize worker properties when creating an executor.
    ...
    @attention
    xthread::WorkerInterface::scheduler_prologue and xthread::WorkerInterface::scheduler_eiplogue
    ...
    */
    ...
    /**
    @brief helper function to create an instance derived from xthread::WorkerInterface

    @tparam T type derived from xthread::WorkerInterface
