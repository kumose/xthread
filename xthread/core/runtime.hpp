...
#include <xthread/core/executor.hpp>
...
namespace xthread {
    ...
    xthread::Task A = taskflow.emplace([&](xthread::Runtime& rt){
    ...
    */
    ...
    public:
        ...
        */
        ...
        Unlike xthread::Executor::async, the task created here is bound to the runtime object and
        is implicitly synchronized at the end of the runtime's scope.
        Applications may also call xthread::Runtime::corun explicitly to wait for all
        ...
        */
        ...
        Similar to xthread::Runtime::async, but takes a parameter of type xthread::TaskParams to initialize
        ...
        */
        ...
        This function is more efficient than xthread::Runtime::async and is recommended when the result
        ...
        */
        ...
        Similar to xthread::Runtime::silent_async, but takes a parameter of type xthread::TaskParams to initialize
        the created asynchronous task.
        ...
        */
        ...
        This member function is more efficient than xthread::Runtime::dependent_async
        ...
        @code{.cpp}
        taskflow.emplace([](xthread::Runtime& rt){
          xthread::AsyncTask A = rt.silent_dependent_async([](){ printf("A\n"); });
          xthread::AsyncTask B = rt.silent_dependent_async([](){ printf("B\n"); });
        ...
        */
        ...
        @code{.cpp}
        taskflow.emplace([](xthread::Runtime& rt){
          xthread::AsyncTask A = rt.silent_dependent_async("A", [](){ printf("A\n"); });
          xthread::AsyncTask B = rt.silent_dependent_async("B", [](){ printf("B\n"); });
        ...
        */
        ...
        returned by xthread::Runtime::dependent_async and xthread::Runtime::silent_dependent_async
        ...
        */
        ...
        You can mix the use of xthread::AsyncTask handles
        returned by xthread::Runtime::dependent_async and rt::Runtime::silent_dependent_async
        when specifying task dependencies.
        */
        template<typename F, typename I,
            std::enable_if_t<!std::is_same_v<std::decay_t<I>, AsyncTask>, void>* = nullptr
        ...
        */
        ...
        /**
        @brief equivalent to xthread::Runtime::corun - just an alias for legacy purpose
        */
        void corun_all();
    ...
    >
    xthread::AsyncTask Runtime::silent_dependent_async(F &&func, Tasks &&... tasks) {
    ...
    >
    xthread::AsyncTask Runtime::silent_dependent_async(
    ...
    >
    xthread::AsyncTask Runtime::silent_dependent_async(F &&func, I first, I last) {
    ...
    */
    ...
    inline void Executor::_invoke_nonpreemptive_runtime_task(Worker &worker, Node *node) {
        _observer_prologue(worker, node);
        xthread::NonpreemptiveRuntime nprt(*this, worker);
        TF_EXECUTOR_EXCEPTION_HANDLER(worker, node, {
