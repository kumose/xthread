...
namespace xthread {
    ...
    A xthread::AsyncTask is a lightweight handle that retains @em shared ownership
    ...
    xthread::AsyncTask A = executor.silent_dependent_async([](){});
    ...
    xthread::AsyncTask B = executor.silent_dependent_async([](){}, A);
    @endcode

    xthread::AsyncTask is implemented based on the logic of
    ...
    */
    ...
    public:
        ...
        */
        ...
        @code{.cpp}
        xthread::AsyncTask task = executor.silent_dependent_async([](){});
        ...
        */
        ...
        (with `memory_order_relaxed` load) the number of xthread::AsyncTask instances that manage
        the current task.
