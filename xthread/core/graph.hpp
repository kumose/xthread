...
#include <xthread/utility/macros.hpp>
...
#include <xthread/utility/serializer.hpp>
#include <xthread/utility/lazy_string.hpp>
#include <xthread/core/error.hpp>
#include <xthread/core/declarations.hpp>
#include <xthread/core/semaphore.hpp>
#include <xthread/core/environment.hpp>
#include <xthread/core/topology.hpp>
#include <xthread/core/tsq.hpp>
...
namespace xthread {
    ...
    */
    class Node {
        ...
        struct Runtime {
            ...
            std::function<void(xthread::Runtime &)> work;
        };
        ...
        struct NonpreemptiveRuntime {
            ...
            std::function<void(xthread::NonpreemptiveRuntime &)> work;
        };
        ...
        struct Subflow {
            ...
            std::function<void(xthread::Subflow &)> work;
            Graph subgraph;
        };
        ...
        struct Async {
            ...
            std::variant<
                std::function<void()>,
                std::function<void(xthread::Runtime &)>, // silent async
                std::function<void(xthread::Runtime &, bool)> // async
            > work;
        };
    ...
    */
     ...
     * with the exact signature `xthread::Graph& graph()`. It uses SFINAE and `std::void_t`
     * to detect the presence of the member function and its return type.
     *
     * @tparam T The type to inspect.
     * @retval true If the type `T` has a member function `xthread::Graph& graph()`.
     ...
     *
     * struct A {
     *   xthread::Graph& graph() { return my_graph; };
     *   xthread::Graph my_graph;
     *
    ...
    } // end of namespace xthread::detail ---------------------------------------------
