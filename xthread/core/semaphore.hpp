...
namespace xthread {
    ...
    A xthread::Semaphore object starts with an initial count.
    ...
    @code{.cpp}
    xthread::Executor executor(8);   // create an executor of 8 workers
    xthread::Taskflow taskflow;

    xthread::Semaphore semaphore(1); // create a semaphore with initial count 1

    SmallVector<xthread::Task> tasks {
    ...
    */
    ...
    public:
        ...
        A default semaphore has the value of zero. Users can call xthread::Semaphore::reset
        ...
        */
        ...
        @code{.cpp}
        xthread::Semaphore semaphore(4);  // concurrency constraint of 4 workers
        @endcode
        */
