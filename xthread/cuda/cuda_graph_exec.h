...
class cudaGraphExecBase : public std::unique_ptr<std::remove_pointer_t<cudaGraphExec_t>, Deleter> {
  ...
  */
  ...
  This method updates the parameter of the given host task (similar to xthread::cudaFlow::host).
  */
  template <typename C>
  ...
  The method is similar to xthread::cudaFlow::kernel but operates on a task
  of type xthread::cudaTaskType::KERNEL.
  ...
  */
  ...
  The method is similar to xthread::cudaFlow::memset but operates on a task
  of type xthread::cudaTaskType::MEMSET.
  ...
  */
  ...
  The method is similar to xthread::cudaFlow::memcpy but operates on a task
  of type xthread::cudaTaskType::MEMCPY.
  The source/destination memory may have different address values but
  must be allocated from the same contexts as the original
  source/destination memory.
  */
  ...
  The method is similar to xthread::cudaFlow::zero but operates on
  a task of type xthread::cudaTaskType::MEMSET.
  ...
  */
  ...
  The method is similar to xthread::cudaFlow::fill but operates on a task
  of type xthread::cudaTaskType::MEMSET.
  ...
  */
  ...
  The method is similar to xthread::cudaFlow::copy but operates on a task
  of type xthread::cudaTaskType::MEMCPY.
  The source/destination memory may have different address values but
  must be allocated from the same contexts as the original
  source/destination memory.
