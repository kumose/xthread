...
#include <xthread/cuda/cuda_error.h>

/**
@file cuda_execution_policy.h
...
class cudaExecutionPolicy {
  ...
  */
  ...
  The function is used to allocate a buffer for calling xthread::cuda_reduce,
  xthread::cuda_uninitialized_reduce, xthread::cuda_transform_reduce, and
  xthread::cuda_uninitialized_transform_reduce.
  */
  template <typename T>
  static unsigned reduce_bufsz(unsigned count);

  /**
  @brief queries the buffer size in bytes needed to call xthread::cuda_min_element
  ...
  */
  ...
  /**
  @brief queries the buffer size in bytes needed to call xthread::cuda_max_element
  ...
  */
  ...
  xthread::cuda_inclusive_scan, xthread::cuda_exclusive_scan,
  xthread::cuda_transform_inclusive_scan, and xthread::cuda_transform_exclusive_scan.
  */
  template <typename T>
  ...
  The function is used to allocate a buffer for calling
  xthread::cuda_merge and xthread::cuda_merge_by_key.
  */
