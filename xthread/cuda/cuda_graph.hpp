...
#include <xthread/cuda/cuda_memory.hpp>
#include <xthread/cuda/cuda_stream.hpp>
#include <xthread/cuda/cuda_meta.hpp>
...
class cudaGraphBase : public std::unique_ptr<std::remove_pointer_t<cudaGraph_t>, cudaGraphDeleter> {
  ...
  */
  ...
  @tparam C callable type
  @tparam E execution poligy (default xthread::cudaDefaultExecutionPolicy)
