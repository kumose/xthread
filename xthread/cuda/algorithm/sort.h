...
/**
@file taskflow/cuda/algorithm/sort.h
@brief CUDA sort algorithm include file
*/

namespace xthread::detail {
...
@tparam K key type
@tparam V value type (default xthread::cudaEmpty)

@param count number of keys/values to sort

The function is used to allocate a buffer for calling xthread::cuda_sort.
...
This method is equivalent to xthread::cuda_sort_by_key without values.
