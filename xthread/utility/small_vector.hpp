...
namespace xthread {
    ...
    */
    ...
    void SmallVectorTemplateBase<T, isPodLike>::grow(size_t MinSize) {
        ...
        size_t NewCapacity = size_t(xthread::detail::NextCapacity(CurCapacity + 2));
    ...
    */
    ...
    public:
        ...
        */
        ...
        //explicit SmallVector(const xthread::iterator_range<RangeTy> &R)
        //    : SmallVectorImpl<T>(N) {
...
namespace std {
    ...
    template<typename T>
    inline void
    swap(xthread::SmallVectorImpl<T> &LHS, xthread::SmallVectorImpl<T> &RHS) {
        LHS.swap(RHS);
    }
    ...
    template<typename T, unsigned N>
    inline void
    swap(xthread::SmallVector<T, N> &LHS, xthread::SmallVector<T, N> &RHS) {
        LHS.swap(RHS);
    }
