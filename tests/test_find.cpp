...
#include <xthread/algorithm/find.hpp>
...
void silent_async(unsigned W) {
  ...
  for(size_t n = 0; n <= 65536; n <= 256 ? n++ : n=2*n+1) {
    ...
    executor.silent_async(xthread::make_find_if_task(input.begin(), input.end(), itr1, P1));
    executor.silent_async(xthread::make_find_if_task(input.begin(), input.end(), itr2, P2));
...
void silent_dependent_async(unsigned W) {
  ...
  for(size_t n = 0; n <= 65536; n <= 256 ? n++ : n=2*n+1) {
    ...
    executor.silent_dependent_async(xthread::make_find_if_task(input.begin(), input.end(), itr1, P1));
    executor.silent_dependent_async(xthread::make_find_if_task(input.begin(), input.end(), itr2, P2));
