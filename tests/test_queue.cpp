...
#include <doctest.h>
#include <xthread/utility/mpmc.hpp>
...
void bounded_tsq_owner() {
  ...
  xthread::BoundedTaskQueue<size_t*, LogSize> queue;
...
void unbounded_tsq_owner() {
  ...
  for(size_t N=1; N<=777777; N=N*2+1) {
    xthread::UnboundedTaskQueue<void*> queue;
...
void bounded_tsq_n_consumers(size_t M) {
  ...
  xthread::BoundedTaskQueue<void*> queue;
